    ...
    <>
      {posts && posts.length > 0 ? (
        <div className="max-w-4xl mx-auto p-4">
          <div className=" text-center grid grid-cols-1 lg:grid-cols-2 gap-6">
            ...
            {posts.map((post) => (
              <div
                key={post.id}
                className="flex lg:flex-col lg:items-center justify-around min-w-[220px] h-full mb-6 p-6 border rounded-lg shadow-md bg-white "
              >
                <div>
